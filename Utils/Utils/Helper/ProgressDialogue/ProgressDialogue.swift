...
public class ProgressDialogue : UIView {
    ...
    func animateStop() {
        animateKeyPath(keyPath: #keyPath(CAShapeLayer.strokeEnd), duration: 0.0, times: [], values: [])
        animateKeyPath(keyPath: "transform.rotation", duration: 0.0, times: [], values: [])
    }
